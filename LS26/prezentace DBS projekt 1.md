...
## Klik
Hratelná postava je taková šablonová entita, která v sobě drží maximální hodnoty atributů hráče které mohu být postupem času ovlivněny jejími zkušenostmi. Dále je tu entita hráč,, která představuje samotného hráče, který může mít více postav. Každá postava má nějakou třídu, která určuje její herní styl. Zároveň je postava spojena přes entitu souboj se strašidlem , která představuje záznam o tom že spolu postava a strašidlo bojovali. V zadání bylo také zmíněno, že si potřebujeme ukládat údaje o postavě na začátku a konci kola. Což řešíme přes entitu uložení. Ta má atributy kolo uložení a fáze kola, které určují blížíš informace. Dále uložení má nějaký stav postavy, kde si ukládáme stav postavy v dané chvíli. taktéž má i  stav inventáře, kde je například monžstí dukátů, artefakty, či léčiva. Dále máme entitu artefaktu, která má nějakou schopnost, dále je  vzadábí zmíněno že artefakt můl Specifická pro tuto entitu je zde oblouková vazba, která říká, že buď je artefakt v kořisti a nebo v inventáři. Dále je v zadání specifikováno to, že v místnosti se mohou nacházet lekraničky nebo další léčiva. To řešíme právě přes entitu Léčivo, které mají svoji učinost. Toto léčivo dále skládáme do balicku s lečivem, kde v kořisti může být více léčiv díky právě této entitě.
