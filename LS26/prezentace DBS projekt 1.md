...
## Klik
Hratelná postava je taková šablonová entita, která v sobě drží maximální hodnoty atributů hráče které mohu být postupem času ovlivněny jejími zkušenostmi. Dále je tu entita hráč,, která představuje samotného hráče, který může mít více postav. Každá postava má nějakou třídu, která určuje její herní styl. Zároveň je postava spojena přes entitu souboj se strašidlem , která představuje záznam o tom že spolu postava a strašidlo bojovali. 
## Klik
