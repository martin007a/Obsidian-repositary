**Výroková logika** - umožňuje analyzovat věty pouze do úrovně elementárních
výroků, jejichž strukturu dále nezkoumá.
### Výrok
**Výrok** je tvrzení (Oznamovací věta v přirozeném jazyce), o němž je smysluplné prohlásit, zda je pravdivé či nepravdivé.
![[Pasted image 20250929182737.png]]
- Z formálního hlediska nezkoumáme význam jednotlivých výroků.
- Výroky jsou zastoupeny výrokovými proměnnými
