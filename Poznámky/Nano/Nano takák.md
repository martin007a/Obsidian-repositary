...
| Přepínač  | Popis                                             |
| --------- | ------------------------------------------------- |
| `nano -l` | Zobrazí čísla řádků                               |
| `nano -c` | Zobrazí aktuální pozici kurzoru                   |
| `nano -m` | Povolení myši (v terminálech, které to podporují) |
| `nano -i` | Automatické odsazování při novém řádku            |
### Kopírování a vkládání textu v Nano
| Akce                             | Klávesová zkratka                                | Popis                                                 |
| -------------------------------- | ------------------------------------------------ | ----------------------------------------------------- |
| **Označit začátek textu (mark)** | `Ctrl + ^` _(Ctrl + Shift + 6 na CZ klávesnici)_ | Nastaví začátek výběru                                |
| **Pohybem kurzoru označuj text** | šipkami                                          | Označuješ oblast ke kopírování                        |
